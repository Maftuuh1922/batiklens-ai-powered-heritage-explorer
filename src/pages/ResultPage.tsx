    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-24 text-center">
          <h2 className="text-3xl md:text-5xl font-serif font-bold mb-6">Dossier Missing</h2>
          <Link to="/scan">
            <Button variant="link" className="text-foreground font-black underline underline-offset-4 text-[10px] uppercase tracking-[0.3em]">
